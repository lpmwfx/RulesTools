...
impl Issue {
    ...
    pub fn rule_ref(&self) -> &'static str {
        match self.rule_id.as_str() {
            ...
            id if id.starts_with("js/jsdoc") => "js/docs.md",
            id if id.starts_with("js/modules") => "js/modules.md",
            id if id.starts_with("uiux/mother-child") => "uiux/mother-child.md",
            id if id.starts_with("uiux/state-flow") => "uiux/state-flow.md",
            id if id.starts_with("slint/docs") => "slint/docs.md",
            id if id.starts_with("slint/tokens") => "slint/tokens.md",
            id if id.starts_with("slint/globals") => "slint/globals.md",
            id if id.starts_with("slint/strings") => "slint/strings-global.md",
            id if id.starts_with("python/types") => "python/types.md",
            id if id.starts_with("python/naming") => "python/naming.md",
            id if id.starts_with("python/validation") => "python/validation.md",
            id if id.starts_with("global/install") => "global/install-architecture.md",
            id if id.starts_with("cpp/naming") => "cpp/naming.md",
            id if id.starts_with("cpp/docs") => "cpp/docs.md",
            id if id.starts_with("cpp/safety") => "cpp/safety.md",
            id if id.starts_with("kotlin/naming") => "kotlin/naming.md",
            id if id.starts_with("kotlin/docs") => "kotlin/docs.md",
            id if id.starts_with("csharp/naming") => "csharp/naming.md",
            id if id.starts_with("csharp/docs") => "csharp/docs.md",
            id if id.starts_with("css/tokens") => "css/tokens.md",
            _ => "",
        }
    }
